...
#ifndef ORG_KDE_KWIN_BLUR_CLIENT_PROTOCOL_H
#define ORG_KDE_KWIN_BLUR_CLIENT_PROTOCOL_H
...
/**
 * @page page_org_kde_kwin_blur The org_kde_kwin_blur protocol
 * @section page_ifaces_org_kde_kwin_blur Interfaces
...
#define ORG_KDE_KWIN_BLUR_RELEASE 0
